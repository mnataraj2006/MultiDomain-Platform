...
import './CustomerDashboard.css'; // Reusing existing styling which defined .dashboard-header
    ...
    return (
        <header className="dashboard-header">
            ...
            <nav className="header-nav">
                ...
                <Link to="/services" className={`header-link ${active === 'Book Service' ? 'active' : ''}`}>
                    <PlusIcon /> <span>Book Service</span>
                </Link>
                <Link to="/my-bookings" className={`header-link ${active === 'my-bookings' ? 'active' : ''}`}>
                    <ListIcon /> <span>My Bookings</span>
                </Link>

                {/* Secondary Links often grouped, but here linear for simplicity */}
                <Link to="/notifications" className={`header-link ${active === 'notifications' ? 'active' : ''}`}>
                    <BellIcon /> <span>Updates</span>
                </Link>
                <Link to="/customer/profile" className={`header-link ${active === 'profile' ? 'active' : ''}`}>
                    <UserIcon /> <span>Profile</span>
                </Link>
                <Link to="/settings" className={`header-link ${active === 'settings' ? 'active' : ''}`}>
